                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-8">
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <button
                                        type="submit"
                                        className="btn btn-primary btn-block my-2 login--btn"
                                ...
                                <br />
                                <GoogleAuth apiUrl={props.apiUrl} showAlert={props.showAlert}/>
                                <div id="signIn" className="form-text mt-4 redirect">
                                    New to iNotebook?
